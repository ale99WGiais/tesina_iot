...
\paragraph{} Nel \emph{sistema presentato} esistono soltanto i \textbf{documenti}. Essi sono \emph{contenitori di dati}, ed hanno associati alcuni \emph{metadati} (in versione semplificata rispetto unix). 
...
\section{Comandi gestiti client}
