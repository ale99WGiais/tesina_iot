...
{\tiny }				\includegraphics[width=0.93\textwidth]{polloPallido}\vfil}\vss}
	...
	\begin{center}  
		...
		\medskip
		\vspace{\stretch{0.25}}
		\titlesc{CREAZIONE DI UN FILE SYSTEM DISTRIBUITO}       % Inserire il titolo
...
\paragraph{} Lo scopo del progetto è la realizzazione di un \textbf{file system distribuito}\cite{distributedfs}. 
